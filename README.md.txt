...
в противном случае - выводится сообщение об отсутствии товара в таблице. +- (Ошибку нужно вывести в баре)
3. В таблице приложения подсчитываются общая сумма пробитых товаров, а также изменяются остатки соотв. образом.
4. Пользователь может на основе этих данных составить нуменклатуру/счет, либо другой договор/таблицу (обсуждается).
